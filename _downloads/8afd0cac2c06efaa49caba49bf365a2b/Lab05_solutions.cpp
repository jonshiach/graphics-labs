...
//        glm::mat4 transformation = rotate * translate * scale;
        ...
        // Exercise 1
//        glm::mat4 translate = glm::translate(glm::mat4(1.0f), glm::vec3(0.5f * cos(time), 0.5f * sin(time), 0.0f));
        glm::mat4 translate = MyLib::translate(glm::mat4(1.0f), glm::vec3(0.5f * cos(time), 0.5f * sin(time), 0.0f));
        
        // Exercise 2
//        glm::mat4 rotate = glm::rotate(glm::mat4(1.0f), -2 * time, glm::vec3(0.0f, 0.0f, 1.0f));
        glm::mat4 rotate = MyLib::rotate(glm::mat4(1.0f), -2 * time, glm::vec3(0.0f, 0.0f, 1.0f));
        
        // Exercise 3
//        glm::mat4 scale = glm::scale(glm::mat4(1.0f), glm::vec3(1.0f + 0.5f * sin(5 * time), 1.0f + 0.5f * sin(5 * time), 1.0f));

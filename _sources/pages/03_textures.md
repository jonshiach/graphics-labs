...
3. Apply a texture of your choice to the rectangle (e.g., a selfie). You will need to ensure that the source image is a 4-bit bitmap so an online converter such as <a href="https://online-converting.com/image/convert2bmp/" target="_blank">https://online-converting.com/image/convert2bmp/</a> are useful for converting from various image formats.
